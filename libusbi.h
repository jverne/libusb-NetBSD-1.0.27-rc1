...
#else
//ALS//#if defined(__HAIKU__) && defined(__GNUC__) && !defined(__clang__)
...
//ALS//#define usbi_atomic_load(a)    __atomic_load_n((a), __ATOMIC_SEQ_CST)
#define usbi_atomic_load(a)   __sync_fetch_and_add((a),0)
//ALS//#define usbi_atomic_store(a, v)        __atomic_store_n((a), (v), __ATOMIC_SEQ_CST) 
#define usbi_atomic_store(a, v) do { \
__sync_synchronize();  (*(a)) = (v);  __sync_synchronize(); \
                                   }while(0)      
//ALS//#define usbi_atomic_inc(a)     __atomic_add_fetch((a), 1, __ATOMIC_SEQ_CST)
#define usbi_atomic_inc(a)     __sync_add_and_fetch((a),1)
//ALS//#define usbi_atomic_dec(a)     __atomic_sub_fetch((a), 1, __ATOMIC_SEQ_CST)
#define usbi_atomic_dec(a)     __sync_sub_and_fetch((a), 1)
#else
#include <stdatomic.h>
...
void usbi_log(struct libusb_context *ctx, enum libusb_log_level level,
	const char *function, const char *format, ...) __attribute__((format(printf, 4, 5)));
